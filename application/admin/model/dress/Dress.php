...
class Dress extends Model
{
    ...
    {
        return $this->belongsTo('dress_category', 'category_id', 'id', [], 'LEFT')->setEagerlyType(0);
    }
    ...
    {
        return $this->hasMany('dress_spec','goods_id','goods_id');
    }
    ...
    {
        return $this->belongsToMany('spec_value', 'dress_spec_rel','spec_value_id','goods_id');
    }
    ...
    public function removesku(){
        // 删除商品sku
        (new DressSpec())->removeAll($this['goods_id']);
    }
    /**
     * 获取规格信息
     */
