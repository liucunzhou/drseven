...
use app\admin\model\dress\Spec as SpecModel;
use app\admin\model\dress\SpecValue as SpecVauleModel;
...
class Dress extends Backend
{
    ...
    /**
     * LitestoregLitestoregoods模型对象oods模型对象
     * @var \app\admin\model\1
     */
    ...
    public function _initialize()
    {
        ...
        $this->SpecValueModel = new SpecVauleModel;


        $this->model = new  \app\admin\model\dress\Dress();
