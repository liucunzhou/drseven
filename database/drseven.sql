...
INSERT INTO `dr_admin` VALUES (1,'admin','Admin','fcd6223094e1c4a5abeb0c739b884505','c2821b','/assets/img/avatar.png','admin@admin.com',0,1575019099,1492186163,1575019099,'c24efbde-6439-43e8-832b-d864fa698f0e','normal',NULL);
...
CREATE TABLE `dr_admin_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=418 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='管理员日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dr_auth_rule` (
  ...
  KEY `pid` (`pid`),
  KEY `weigh` (`weigh`)
) ENGINE=InnoDB AUTO_INCREMENT=303 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='节点表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dr_dress` (
  ...
  `code_ids` varchar(45) DEFAULT NULL,
  `categroy_id` varchar(45) DEFAULT NULL,
  ...
  `is_vip_free` varchar(45) DEFAULT NULL,
  `is_inner` varchar(45) DEFAULT NULL,
  `status` int(11) DEFAULT NULL,
  `createtime` int(11) DEFAULT NULL,
  `updatetime` int(11) DEFAULT NULL,
  `deletetime` int(11) DEFAULT NULL,
...
INSERT INTO `dr_user` VALUES (1,1,'admin','admin','c13f62012fd6a8fdf06b3452a94430e5','rpR6Bv','admin@163.com','13888888888','',0,0,'2017-04-15','',0.00,0,1,1,1516170492,1516171614,'127.0.0.1',0,'127.0.0.1',1491461418,0,1516171614,'','normal','');
...
INSERT INTO `dr_version` VALUES (1,'1.1.1,2','1.2.1','20M','更新内容','https://www.fastamdin.net/download.html',1,1520425318,0,0,'normal');
...
-- Dump completed on 2019-12-04 12:48:09
