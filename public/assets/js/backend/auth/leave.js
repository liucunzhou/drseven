define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'auth/leave/index' + location.search,
                    add_url: 'auth/leave/add',
                    edit_url: 'auth/leave/edit',
                    del_url: 'auth/leave/del',
                    multi_url: 'auth/leave/multi',
                    table: 'leave',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'category_leave_id', title: __('Category_leave_id')},
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'auth/leave/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
