define(['jquery', 'bootstrap', 'backend', 'table', 'form', 'template', 'dress'], function ($, undefined, Backend, Table, Form, Template, dress) {
        ...
        index: function () {
            ...
            Table.api.init({
                extend: {
                    ...
                    rent_url: 'order/rent/add',
                    sale_url: 'order/sale/add',
